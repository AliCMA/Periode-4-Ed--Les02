...
const textArray = [ 'Welkom op Ali zijn portfolio', 'kan ik helpen?', 'Dit is mijn portfolio speech helper', 'Welkom op zijn portfolio'];
...
class TextData{
    ...
    welcomeEn(){
        let textString = ("Welkom op Ali zijn portfolio, hoe kan ik u helpen?");
        return textString;
    }
    welcomeDu(){
        let textString = ("Welkom bij Ali zijn portfolio. Met wat kan ik u helpen ?");
        return textString;
    }
}
